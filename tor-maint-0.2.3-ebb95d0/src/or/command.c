...
#define PROCESS_CELL(tp, cl, cn) command_process_ ## tp ## _cell(cl, cn)
  ...
  switch (cell->command) {
    ...
    case CELL_CREATE_FAST:
		//log_fn(LOG_INFO, LD_PROTOCOL,"------------> Got create cell", cell->command);
    ...
    case CELL_CREATED_FAST:
		//log_fn(LOG_INFO, LD_PROTOCOL,"------------> Got createD cell", cell->command);
      ++stats_n_created_cells_processed;
      PROCESS_CELL(created, cell, conn);
      break;
    case CELL_RELAY:
    case CELL_RELAY_EARLY:
		//log_fn(LOG_INFO, LD_PROTOCOL,"------------> Got relay cell", cell->command);
      ++stats_n_relay_cells_processed;
      PROCESS_CELL(relay, cell, conn);
      break;
    case CELL_DESTROY:
		//log_fn(LOG_INFO, LD_PROTOCOL,"------------> Got destroy cell", cell->command);
      ++stats_n_destroy_cells_processed;
      PROCESS_CELL(destroy, cell, conn);
      break;
    case CELL_VERSIONS:
		//log_fn(LOG_INFO, LD_PROTOCOL,"------------> Got version cell", cell->command);
      tor_fragile_assert();
      break;
    case CELL_NETINFO:
		//log_fn(LOG_INFO, LD_PROTOCOL,"------------> Got netinfo cell", cell->command);
