...
#else
typedef log_domain_mask_t_v1 log_domain_mask_t;
#endif
 ...
 * arguments. */
#define stringer( x,y,z ) x#y#z
#define log_fn (_log_fn_function_name=__FUNCSIG__ " -> "__FILE__ ),_log_fn
#define log_debug (_log_fn_function_name=__FUNCSIG__ " -> "__FILE__ ),_log_debug
